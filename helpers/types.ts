...
export type ieMoneyPoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  | 'DAI'
  | 'USDC'
  | 'USDT'
...
export interface ieMoneyParamsPerNetwork<T> {
  [eMoneyNetwork.testnet]: T;
  [eMoneyNetwork.mainnet]: T;
}
...
export interface IeMoneyConfiguration extends ICommonConfiguration {
  ReservesConfig: ieMoneyPoolAssets<IReserveParams>;
}
